...
exports.getReadableHashRateString = function (hashrate) {
    var i = -1;
    var byteUnits = [' KSol', ' MSol', ' GSol', ' TSol', ' PSol'];
    do {
...
exports.bufferToCompactBits = function (startingBuff) {
    var bigNum = bufferToBigInt(startingBuff);
    var buff = bigIntToBuffer(bigNum);
...
exports.bignumFromBitsBuffer = function (bitsBuff) {
    ...
    var bigBits = bufferToBigInt(bitsBuff.slice(1));
    var target = bigBits * (2n ** (8n * BigInt(numBytes - 3)));
    return target;
};
...
exports.convertBitsToBuff = function (bitsBuff) {
    ...
    var resultBuff = bigIntToBuffer(target);
