...
var BigIntType = function (value) { return typeof value === 'bigint' }
var ECPoint = function (value) {
...
function tuple(...types) {
  return function (values) {
    if (!isArray(values) || values.length !== types.length) return false
  ...
  if (typeof spec === 'object') {
    return function (value) {
      ...
      return Object.keys(spec).every(key => {
        var validator = compile(spec[key])
