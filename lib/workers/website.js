...
const algoLoader = require('../algos/loader.js');
...
module.exports = function () {
    ...
    const limiter = new RateLimiter(15 * 60 * 1000, 100); // 15 minutes, 100 requests

    daemon.interface(config.daemons, (severity, message) => {
        ...
        if (pathname === '/') {
            ...
            (async () => {
                try {
                    ...
                    const algo = algoLoader.getAlgoInstance(config);
                    ...
                    const html = renderTemplate(templatePath, {
                        ...
                        hashrate: hashrate,
                        hashUnit: algo.solutionUnits[0].trim(),
